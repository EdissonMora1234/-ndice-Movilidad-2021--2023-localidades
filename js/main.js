document.addEventListener('DOMContentLoaded', function() {
    var map = L.map('map').setView([4.664628, -74.064095], 12);
    ...
    var wmsLayers = [
        { url: 'https://geoserver.scrd.gov.co/geoserver/Investigacion_Cultured_Maps/wms', layerName: 'Investigacion_Cultured_Maps:Subindice_Movilidad_2021', displayName: 'Subindice_Movilidad_2021' },
        { url: 'https://geoserver.scrd.gov.co/geoserver/Investigacion_Cultured_Maps/wms', layerName: 'Investigacion_Cultured_Maps:Subindice_Movilidad_2023', displayName: 'Subindice_Movilidad_2023' }
    ];
